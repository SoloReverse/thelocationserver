...
func (c *CarQuery) collectField(ctx context.Context, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "carsowned":
			...
			c.WithNamedCarsowned(alias, func(wq *UserQuery) {
				*wq = *query
			})
		case "model":
		...
		case "country":
			if _, ok := fieldSeen[car.FieldCountry]; !ok {
				selectedFields = append(selectedFields, car.FieldCountry)
				fieldSeen[car.FieldCountry] = struct{}{}
			}
		case "iconurl":
			if _, ok := fieldSeen[car.FieldIconURL]; !ok {
				selectedFields = append(selectedFields, car.FieldIconURL)
				fieldSeen[car.FieldIconURL] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
...
func (u *UserQuery) collectField(ctx context.Context, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "car":
			if _, ok := fieldSeen[user.FieldCar]; !ok {
				selectedFields = append(selectedFields, user.FieldCar)
				fieldSeen[user.FieldCar] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
